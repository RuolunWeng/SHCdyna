...
SHCdyna is a dynamic and interactive application for musical performance. It allows for the dynamic compilation and execution of code in the Faust programming language, interaction with motion sensors, and the creation of custom touch user interfaces.
...
**Site Github faust2smartphone**: [faust2smartphone](https://github.com/RuolunWeng/faust2smartphone)
